...
# Statement of need  
Antimicrobial resistance (AMR) remains a major public health threat. Mobile Genetic Elements (MGEs) play a critical role in the acquisition and dissemination of resistance genes to pathogenic bacteria [@pradier_ecology_2023]. Consequently, identifying and characterizing MGEs is essential for understanding AMR epidemiology. Although advances in high-throughput sequencing have made genomic analysis widely accessible, user-friendly tools for comprehensive mobilome analysis and its association with AMR remain limited. This lack of accessible, integrated solutions represents a bottleneck for researchers seeking to investigate the role of the mobilome in the dissemination of resistance.
